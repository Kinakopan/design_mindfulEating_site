...
export default function Home() {
  ...
  return (
    ...
    <br></br>
      ...
      <Questions id="recipe" btName="want to cook" txt="I want to prepare healthy daily meals but don’t know what to cook"></Questions>
      <Questions id="restaurant" btName="dont want to cook" txt="I want to go vegan easily and healthfully but don’t want to cook"></Questions>
      <Questions id="localFood" btName="want to buy" txt="I want to buy organic ingredients but don't know where"></Questions>
